  ...
  return (
    <>
      ...
      <div className='bg-gray-100'>
        ...
        {/* Values */}
        <section id='values' className='py-10 overflow-x-hidden'>
            ...
            <div
              ...
              <div id='mission-text' className='content-center'>
                ...
                <p className='text-black text-lg md:text-xl'>
                  ...
                  train leaders and workers to serve and build the Kingdom of
                  God.
                </p>
              </div>
              <Image
            ...
            <div
              ...
              <div id='vision-text' className='content-center lg:order-2'>
                ...
                <p className='text-black text-lg md:text-xl text-end'>
                  FBCFI envision to proclaim, promote and advocate the full
                  Gospel of Jesus Christ throughout the Philippines and Overseas
                  by whatever means, form or manner in accordance with the Word
